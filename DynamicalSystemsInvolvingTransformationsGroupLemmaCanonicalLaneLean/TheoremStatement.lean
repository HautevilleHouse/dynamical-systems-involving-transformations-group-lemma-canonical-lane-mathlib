import DynamicalSystemsInvolvingTransformationsGroupLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "dynamical-systems-transformation-group lemma internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
